...
public class Main {
    public static void main(String[] args) {
        ...
        for (int pos = 0; pos < Funciones.coleccion.length; pos++) {
            Funciones.coleccion[pos] = new Disco();
        }
        ...
        do { // ? Mostramos el menú y esperamos la opción del usuario
            ...
            switch (opcion) {
                case 1:
                    Funciones.listado(Funciones.coleccion);
                    break;
                ...
                case 2:
                    ...
                    Funciones.crearDisco(codigo, autor, titulo, genero, duracion);
                    break;
                ...
                case 3:
                    ...
                    for (int pos = 0; pos < Funciones.coleccion.length; pos++) {
                        if (Funciones.coleccion[pos].getCodigo().equals(codigo)) {
                            System.out.print("Introduce el código del disco: ");
                            codigo = read.nextLine();
                            System.out.print("Introduce el autor del disco: ");
                            autor = read.nextLine();
                            ...
                            Funciones.modificarDisco(codigo, autor, titulo, genero, duracion, (byte) pos);
                            encontrado = true;
                            break;
                        }
                    }  if (!encontrado) {
