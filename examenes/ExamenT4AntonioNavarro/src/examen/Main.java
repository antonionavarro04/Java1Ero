...
public class Main {
    public static void main(String[] args) {
        ...
        // ^ Definimos las variables tirada1 y tirada2 que almacenaran el resultado de las dos tiradas
        int tirada1, tirada2;

        // ^ Definimos las variables nomJ1 y nomJ2 para almacenar el nombre de los jugadores
        String nomJ1, nomJ2;
        ...
        Oca.minDado = read.nextInt(); // * Leemos el valor mínimo del dado
        System.out.print("Introducid el valor máximo del dado > ");
        Oca.maxDado = read.nextInt(); // * Leemos el valor máximo del dado

        // ? Salto de Línea Triple
        System.out.println("\n---------------------\n");

        read.nextLine(); // ? Limpiamos el Búfer del Scanner tras leer un número para poder leer un String
        ...
        do{
            ...
            if (Oca.fichaJ1 >= Oca.TAMCIRCUITO){
                break;
            }
